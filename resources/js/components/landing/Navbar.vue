    ...
    >
      ...
      >
        <a
          ...
          href="https://www.maledamirchaye.com/"
          >Maleda Mirchaye</a
        ><button
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            <a
              ...
              href="hzttps://maledamirchaye.com/register"
              > -->
              <!-- <i
                class="lg:text-gray-300 text-gray-500 fab fa-user text-lg leading-lg "
              ></i> -->
              <!-- <span class="inline-block ml-2">Register</span></a
            >
          </li>
          <li class="flex items-center">
            <button
            ...
            >
            <a href="https://maledamirchaye.com/login"> -->

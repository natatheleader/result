<template>
  <div>
          ...
          <div class="flex w-full items-center justify-between px-4">
              ...
              <nav id="navbarCollapse" class="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-dark-2 lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:px-4 lg:py-0 lg:shadow-none dark:lg:bg-transparent xl:px-6">
                <ul class="blcok lg:flex 2xl:ml-20">
                  <li class="group relative">
                    <a href="#home" class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                      Home
                    </a>
                  </li>
                  <li class="group relative">
                    <a href="#about" class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                      About
                    </a>
                  </li>
                  <li class="group relative">
                    <a href="#pricing" class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                      Pricing
                    </a>
                  </li>
                  <li class="group relative">
                    <a href="#team" class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                      Team
                    </a>
                  </li>
                  <li class="group relative">
            ...
            <div class="flex items-center justify-end pr-16 lg:pr-0">
              ...
              <div class="hidden sm:flex">
                ...
                <a href="signup.html" class="signUpBtn rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">
                  Sign Up
                </a>
              </div>
            </div>
            ...
            <div class="-mx-4 flex flex-wrap items-center">
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <ul class="mb-10 flex flex-wrap items-center justify-center gap-5">
                            <li>
                                <a href="https://maledamirchaye.com/register" class="inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-gray-2 hover:text-body-color">
                                    Register
                                </a>
                            </li>
                            <li>
                                <a href="https://maledamirchaye.com/login" target="_blank" class="flex items-center gap-4 rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark">
                                    Login
                                </a>
                            </li>
                        </ul>
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                        <div class="mt-16">
                            <img src="../../assets/images/dash2.jpg" alt="Dashboard Snap Shot" class="mx-auto max-w-full rounded-t-xl rounded-tr-xl"/>
                        </div>
    ...
    <section class="pb-8 pt-20 dark:bg-dark lg:pb-[70px] lg:pt-[120px]">
        <div class="container">
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                        ...
                        <p class="text-base text-body-color dark:text-dark-6">Our platform have many features, We have presented some of the best features here.</p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Your data is protected with advanced encryption. Secure login with two-factor authentication. Compliant with industry standards.
                        </p>
                ...
                <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Make transactions in seconds. User-friendly interface for seamless navigation. No hidden fees or complex processes.
                </p>
                <!-- <a
            ...
            <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
                ...
                <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Stay informed with important announcements. Access essential updates and notifications. Never miss a deadline or opportunity.
                </p>
                <!-- <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
            ...
            <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
                ...
                <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                    Withdrawal, History, and More
                </h4>
                <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Easily withdraw funds to your preferred account. Track your transaction history with detailed records. Enjoy a range of additional features for your convenience.
                </p>
                <!-- <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4 lg:w-1/2">
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                  The New Way To Financial Freedom In Ethiopia,
                </h2>
                <p
                ...
                <a
                  target="_blank"
                  href="https://maledamirchaye.com/register"
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="https://cdn.mos.cms.futurecdn.net/Srsb8SRXneABugLXWQ5nuR.jpg"
                      alt="about image"
                ...
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="https://moneylion.nyc3.cdn.digitaloceanspaces.com/wp-content/uploads/2021/02/16202439/Black-Finance.jpg"
                      alt="about image"
                      class="h-full w-full object-cover object-center"
                    />
                  </div>
    ...
    <!-- <c-t-a-component></c-t-a-component> -->
    <!-- ====== CTA Section Start -->
    <section
          ...
          <div class="-mx-4 flex flex-wrap items-stretch">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                ...
                >
                Ready to embark on a journey towards financial independence and self-improvement? Welcome aboard.
                </p>
                <a
                  target="_blank"
                  href="https://maledamirchaye.com/register"
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <p class="mb-6 text-base text-body-color dark:text-dark-6">
                    “Our memb are so impressed. It's intuitive. It's clean.
                    It's distraction free. If you're building a community.’’
                  </p>

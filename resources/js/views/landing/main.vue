<template>
  <body class="bg-neutral-900">
    ...
    <header class="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
      <nav class="relative max-w-[66rem] w-full bg-neutral-800 rounded-[28px] py-3 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 mx-2 lg:mx-auto" aria-label="Global">
        <div class="flex items-center justify-between">
          <!-- Logo -->
          <!-- <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="localhost:8000/land" aria-label="Maleda Mirchaye">
          ...
          <a href="index.html" class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80 w-24 h-auto">
            <img src="https://maledamirchaye.com/build/assets/logo-e3655fc3.png" alt="logo" class="header-logo w-full"/>
          </a>
          <!-- End Logo -->
        ...
        <div id="navbar-collapse" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
          <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
            ...
            <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="#about">About</a>
            <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="#features">Features</a>
            <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="#faq">FAQ</a>
            <a class="text-sm text-white hover:text-neutral-300 md:py-4 focus:outline-none focus:text-neutral-300" href="#contact">Contact</a>
            ...
            <div>
              <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#ff0] font-medium text-sm text-neutral-800 rounded-full focus:outline-none" href="https://maledamirchaye.com/register">
                Get Started
              </a>
            </div>
          </div>
    ...
    <main id="content">
      ...
      <div class="bg-neutral-900">
        <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
          <h1 class="font-semibold text-white text-5xl md:text-6xl">
            <span class="text-[#ff0]">Maleda Mirchaye:</span> Transforming Finance Like Never Before
          </h1>
          <div class="max-w-4xl">
            <p class="mt-5 text-neutral-400 text-lg">
                Maleda Mirchaye is an Ethiopian Finance company that offers a financial service focused on micro-deposits and utilizing a set of rules to rotate funds between users, Helping so many people to reach new heights in finance.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="relative overflow-hidden pt-4 bg-neutral-900">
        ...
        <div class="relative z-10">
          <div class="max-w-5xl px-4 xl:px-0 mx-auto">
            <div class="mb-4">
              <h2 class="text-neutral-400">Trusted by 500+ Clients</h2>
            </div>
      ...
      <!-- About -->
      <div class="bg-neutral-900" id="about">
        <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
          <!-- Title -->
          <div class="max-w-3xl mb-10 lg:mb-14">
            <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">The New Way To Financial Freedom In Ethiopia,</h2>
            <p class="mt-1 text-neutral-400">With the Best Technology</p>
          </div>
          <!-- End Title -->
          ...
          <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
            <div>
              <!-- Blockquote -->
              <blockquote>
                <p class="font-small text-s text-white md:text-2xl md:leading-normal xl:text-m xl:leading-normal">
                    Maleda Mirchaye is an Ethiopian financial services company dedicated to helping people achieve 
                financial prosperity. Our innovative approach centers on micro-deposits and a carefully designed 
                rotation system that enables members to access and grow their funds. 
                  <br />
                  <br />
                  By fostering financial 
                  inclusion and cooperation, we are empowering countless individuals to reach new heights.
                ...
                <footer class="mt-6">
                  <div class="flex items-center">
                    <div class="md:hidden flex-shrink-0">
                      <img class="size-12 rounded-full" src="../../assets/images/dash2.jpg" alt="Image Description">
                    </div>
            ...
            <div class="hidden md:block mb-24 md:mb-0">
              <img class="rounded-xl" src="../../assets/images/dash2.jpg" alt="Image Description">
            </div>
            <!-- End Col -->
          </div>
          <!-- End Grid -->
      ...
      <!-- Features -->
      <div class="bg-neutral-900 bg-gradient-to-t from-black to-transparent" id="features">
        <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
          <!-- Title -->
          <div class="max-w-3xl mb-10 lg:mb-14">
            <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Features</h2>
            <p class="mt-1 text-neutral-400">Our Main Features</p>
          </div>
          <!-- End Title -->
          ...
          <div class="grid grid-cols-1 lg:grid-cols-4 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
            ...
            <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
              <div class="mb-5">
                ...
                <div class="mt-5">
                  ...
                  <h3 class="mt-5 font-medium text-lg text-white">Fast and Easy</h3>
                  <p class="mt-1 text-neutral-400">Make transactions in seconds. User-friendly interface for seamless navigation. No hidden fees or complex processes.</p>
                </div>
              </div>
              <!-- <p class="mt-auto">
                <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] transition focus:outline-none group-focus:border-[#ff0]">
            ...
            <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
              <div class="mb-5">
                ...
                <div class="mt-5">
                  ...
                  <h3 class="mt-5 font-medium text-lg text-white">Notice Board</h3>
                  <p class="mt-1 text-neutral-400"> Stay informed with important announcements. Access essential updates and notifications. Never miss a deadline or opportunity.</p>
                </div>
              </div>
              <!-- <p class="mt-auto">
                <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] transition focus:outline-none group-focus:border-[#ff0]">
            ...
            <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
              <div class="mb-5 ">
                ...
                <div class="mt-5">
                  <!-- <p class="font-semibold text-5xl text-white">20%</p> -->
                  <h3 class="mt-5 font-medium text-lg text-white">Withdrawal, History, and More</h3>
                  <p class="mt-1 text-neutral-400">Easily withdraw funds to your preferred account. Track your transaction history with detailed records. Enjoy a range of additional features for your convenience.</p>
                </div>
              </div>
              <!-- <p class="mt-auto">
                <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] transition focus:outline-none group-focus:border-[#ff0]">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                ...
                <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                  ...
                  <div class="mt-3 sm:mt-5">
                    <h3 class="text-lg sm:text-3xl font-semibold text-white">600+</h3>
                    <p class="mt-1 text-sm sm:text-base text-neutral-400">Registered Users</p>
                  </div>
                </div>
                <!-- End Stats -->
                ...
                <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                  ...
                  <div class="mt-3 sm:mt-5">
                    <h3 class="text-lg sm:text-3xl font-semibold text-white">10+</h3>
                    <p class="mt-1 text-sm sm:text-base text-neutral-400">Amaizing Trainings</p>
                  </div>
                </div>
                <!-- End Stats -->
                ...
                <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                  ...
                  <div class="mt-3 sm:mt-5">
                    <h3 class="text-lg sm:text-3xl font-semibold text-white">200K ETB</h3>
                    <p class="mt-1 text-sm sm:text-base text-neutral-400">In Transaction</p>
                  </div>
                </div>
                <!-- End Stats -->
              </div>
      ...
      <!-- FAQ -->
      <div class="text-white max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="faq">
        <!-- Title -->
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          <h2 class="text-2xl font-bold md:text-3xl md:leading-tight text-white dark:text-neutral-200">
        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div class="grid sm:grid-cols-2 gap-6 md:gap-12">
            <div>
              <h3 class="text-lg font-semibold text-gray-100 dark:text-neutral-200">
                Can I cancel at anytime?
              </h3>
              <p class="mt-2 text-gray-300 dark:text-neutral-400">
                ...
                <div class="space-y-4">
                  ...
                  <div class="relative">
                    ...
                    <label for="hs-tac-message" class="absolute top-0 start-0 p-4 h-full text-neutral-400 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                      ...
                      peer-[:not(:placeholder-shown)]:text-xs
                      peer-[:not(:placeholder-shown)]:-translate-y-1.5
                      peer-[:not(:placeholder-shown)]:text-neutral-400">Your Message</label>
                  </div>
                  <!-- End Textarea -->
                </div>
            ...
            <div class="space-y-14">
              ...
              <div class="flex gap-x-5">
                ...
                <div class="grow">
                  ...
                  <a class="mt-1 text-neutral-400 text-sm" href="#mailto:info@maledamirchaye.com" target="_blank">
                    info@maledamirchaye.com
                  </a>
                </div>
              </div>
              <!-- End Item -->
              ...
              <div class="flex gap-x-5">
                ...
                <div class="grow">
                  ...
                  <p class="mt-1 text-neutral-400">+25199999999<br>+25199999999<br>+25199999999</p>
                  <p class="mt-2">
      ...
      <div class="relative z-10">
        <div class="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
          <div class="inline-flex items-center">
            ...
            <a href="index.html" class="navbar-logo block w-24 h-auto py-5">
              <img src="https://maledamirchaye.com/build/assets/logo-e3655fc3.png" alt="logo" class="header-logo w-full"/>
            </a>
            <!-- End Logo -->
  
            <div class="border-s border-neutral-700 ps-5 ms-5">
              <p class="text-sm text-neutral-400">2024 Maleda Mirchaye</p>
            </div>
          </div>
        </div>
      </div>
